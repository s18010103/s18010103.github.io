...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>X等於1，X +1等於2。這是為什麼呢，原來X已經等於1了，那麼X +1等於1+1，所以答案就是2了。</p><hr><p>如何创建变量——赋值问句</p><p>变量：通过变量名代表或引用某个值</p><p>初始化賦值語句：變量名 = 表達式</p><p>​ /\\</p><p>​ |</p><p>​ 賦值運算符</p><p>賦值運算符是什麼呢?</p><p>賦值運算符是表達式把變量名改成其他的名字。</p>`,41),t=[i];function l(c,o){return s(),a("div",null,t)}const u=n(p,[["render",l],["__file","pygame初識.html.vue"]]);export{u as default};
