import{_ as n}from"./plugin-vue_export-helper-x3n3nnut.js";import{o as s,c as a,d as e}from"./app-hIiil82o.js";const p={},i=e(`<h1 id="_0-目錄" tabindex="-1"><a class="header-anchor" href="#_0-目錄" aria-hidden="true">#</a> 0. 目錄</h1><ul><li>Python第三方庫</li><li>Pygame的簡單介紹</li><li>創建窗体，揹景</li></ul><h1 id="_1-python第三方庫" tabindex="-1"><a class="header-anchor" href="#_1-python第三方庫" aria-hidden="true">#</a> 1. Python第三方庫</h1><div class="language-python line-numbers-mode" data-ext="py"><pre class="language-python"><code><span class="token keyword">import</span> pygame <span class="token comment"># 導入 pygame 庫</span>
