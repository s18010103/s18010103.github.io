...
<span class="token comment"># ---output---</span>
<span class="token number">1</span> <span class="token number">2</span> <span class="token number">3</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="变量名的命名规则" tabindex="-1"><a class="header-anchor" href="#变量名的命名规则" aria-hidden="true">#</a> 变量名的命名规则：</h4><ul><li><p>大小写英文、数学和＿的结合、且不能用数字开头；</p></li><li><p>系統关键词不能做变量名使用；</p><p>​ 获取关键字列表： help(&#39;keywords &#39;)</p></li><li><p>Python中的变量名区分大小写。</p></li><li><p>变量名不能包含空格、但可使用下划线来分隔其中的单词。</p></li><li><p>不要使用python的内置函数名称做变量名</p></li></ul>`,38),t=[i];function l(o,c){return s(),a("div",null,t)}const d=n(p,[["render",l],["__file","01-variable.html.vue"]]);export{d as default};
