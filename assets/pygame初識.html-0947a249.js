import{_ as n,W as s,X as a,a1 as e}from"./framework-1c430c0f.js";const p={},i=e(`<h1 id="_0-目錄" tabindex="-1"><a class="header-anchor" href="#_0-目錄" aria-hidden="true">#</a> 0. 目錄</h1><ul><li>Python第三方庫</li><li>Pygame的簡單介紹</li><li>創建窗体，揹景</li></ul><h1 id="_1-python第三方庫" tabindex="-1"><a class="header-anchor" href="#_1-python第三方庫" aria-hidden="true">#</a> 1. Python第三方庫</h1><div class="language-python line-numbers-mode" data-ext="py"><pre class="language-python"><code><span class="token keyword">import</span> pygame <span class="token comment"># 導入 pygame 庫</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>X等於1，X +1等於2。這是為什麼呢，原來X已經等於1了，那麼X +1等於1+1，所以答案就是2了。</p><hr><p>如何创建变量——赋值问句</p><p>变量：通过变量名代表或引用某个值</p><p>初始化賦值語句：變量名 = 表達式</p><p>​ /\\</p><p>​ |</p><p>​ 賦值運算符</p><p>賦值運算符是什麼呢?</p><p>賦值運算符是表達式把變量名改成其他的名字。</p><p>在 Python 中，我可以通过编写 my_str = _____ 来创建一个包含字符串 &quot;Hello, Python!&quot; 的变量 my_str</p>`,42),t=[i];function l(c,o){return s(),a("div",null,t)}const u=n(p,[["render",l],["__file","pygame初識.html.vue"]]);export{u as default};
